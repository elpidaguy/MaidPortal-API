...
@Entity
@Table(name="tbl_clothingSalary")
public class ClothingSalary extends AbstractEntity{
	...
	public ClothingSalary() {
		super();
	}
	
	public ClothingSalary(double payable, double bonus, double fine, LocalDate forMonth, int maid_id,
	...
	public String toString() {
		return "ClothingSalary [payable=" + payable + ", bonus=" + bonus + ", fine=" + fine + ", forMonth=" + forMonth
